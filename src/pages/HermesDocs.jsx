...
const docs = [
  { name: 'Hermes One Pager', href: '/dx9k2/hermes-one-pager.html' },
  { name: 'Hermes Product Overview', href: '/dx9k2/hermes-product-overview.html' },
]

export default function HermesDocs() {
